...
<ImageWithLabel
  src="/images/posts/ToKiniAndy.jpg"
  width="100"
  height="100"
  alt="by ToKiniAndy"
  label="by ToKiniAndy"
...
2. After installing, you will see a new Yomitan icon 
    <ImageOnly src="/images/posts/yomitan-icon128.png"
      width="20"
      height="20"
      alt="Yomitan Icon"
      rounded="none" 
...
5. You can also add dictionaries to Yomitan by clicking on the "Dictionaries" tab and selecting the dictionaries you want to use. Personally i use Jitendex, its updated with new content every week. <strong>If Jitendex is useful for you, please consider giving the project a <ImageOnly src="/images/star.png" width="20" height="20"/> on GitHub. You can also buy the developer some <Link href="https://ko-fi.com/jitendex" className="text-sky-400">Ko-fi</Link>. </strong>
...
## Example of Yomitan in Action
<ImageWithLabel
  src="/images/posts/yomitan.png"
  width="400"
  height="200"
  alt="Yomitan in Action"
  label="Yomitan in Action"
  href="https://www.youtube.com/watch?v=OJxndUGN8Cg&t=1s"
/>
